...
class Spec_Metrics:
    ...
    def __init__(self, freq=36, direction=24, cdip_buyo=False):
        self.x_freq = generate_freq(new_n=freq, cdip_buyo=cdip_buyo)
        self.theta = generate_dirs(n=direction)
    ...
    def get_significant_wave_height(self, m0):
        ...
        :return: Hs: significant wave height
    ...
    def evaluate_predict_spec_loss(self, y_true, y_predict, data_type="null"):
        """
        evaluate the loss of predict spec parameters
        """
